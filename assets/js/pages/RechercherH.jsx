  ...
  const fetchUsers = async () => {
   ...
   const fetchs =async()=>{
    ...
    const result = await  axios({
        method: 'post',
        url: 'http://127.0.0.1:8000/touslestrajet',
        data:{"datedepart":datedepart.toLocaleDateString()}
      });
      setData(result.data);
    }catch (error) {console.log(error.Response);}
   }
    ...
    const result = await axios({
      ...
      data:
      {
        ...
        type:
          ...
          jours: jours,
          datedepart:datedepart.toLocaleDateString()
      },
    });
...
const sendRequestdetails = useCallback(async (villedepart,villedestination,type,datedepart) => {
  const result = await axios({
    method: "post",
    url: "http://127.0.0.1:8000/trajet",
    data:
...
const handleSubmitdetails = async (villedepart,villedestination,type,datedepart) => {
  const result = await axios({
    method: "post",
    url: "http://127.0.0.1:8000/trajet",
    data:
    ...
    <div>
      <Container>
        ...
        <Row className="justify-content-md-center">
          <Col xs lg="2"></Col>
          <Col md="auto">
            <h1 className='quotes'>voulez-vous vous dèplacer autrement ?</h1>
          </Col>
          <Col xs lg="2"></Col>
        </Row>
        <Row className="justify-content-md-center">
        ...
        <Row md={4}>
          ...
          <Col>
            ...
            Ponctuel <Switch 
            onClick={toggler} id="type" 
            data-tip="Le type de Traget par defaut c'est Ponctuel <br />
            pour switchée à une traget Régulier Basculer le buutton" 
            data-multiline={true}
            /> Regulier
            <ReactTooltip
          place="bottom" 
          ...
          <Col>
            {toggle ? (
              ...
              <Col>
              <Form.Label>Choisi La Date de Départ :</Form.Label>
                       <Calendar id="datedepart"
                       onChange={d=>{setDateDepart(d);
                        fomateddate=d.toLocaleDateString();
                    console.log(datedepart.toLocaleDateString())}}
                    ...
                    <tr>
                      ...
                      <th>  
                            <NavLink className="nav-link" to="/Login">
                              ...
                              //  onClick={()=>handleSubmitdetails(item.villedepart,item.villedestination)}
                               >
                                Détails
                              </button>
                            </NavLink>
